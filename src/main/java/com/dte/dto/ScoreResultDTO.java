...
public class ScoreResultDTO {
  ...
  public static class Builder {
    ...
    public Builder scoreM(Double val) {
      this.scoreM = val;
      return this;
    }

    public Builder scoreC(Double val) {
      this.scoreC = val;
      return this;
    }

    public Builder scoreR(Double val) {
      this.scoreR = val;
      return this;
    }

    public Builder weightM(Double val) {
      this.weightM = val;
      return this;
    }

    public Builder weightC(Double val) {
      this.weightC = val;
      return this;
    }

    public Builder weightR(Double val) {
      this.weightR = val;
      return this;
    }
    ...
    public Builder submissionId(Long val) {
